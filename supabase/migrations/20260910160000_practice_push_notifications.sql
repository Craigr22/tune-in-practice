...
-- pg_cron calls the Edge Function every five minutes. The function itself
-- resolves each subscriber's local time and only sends inside the 9 AM or
-- 9 PM window. These two values belong in Supabase Vault:
